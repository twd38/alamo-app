...
import { BOMPartsManager, BOMPartsItem } from "@/components/library/bom-parts-manager";
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            ...
            <DialogContent className="w-full max-w-[90vw] sm:max-w-[700px] overflow-y-scroll flex flex-col">
                ...
                <DialogFooter>
                    <Button type="submit" disabled={isLoading} isLoading={isLoading} onClick={handleSave}>Save</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    )
