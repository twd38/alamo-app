...
const items: SelectorItem[] = [
  ...
  },
  {
    name: "To-do List",
    icon: CheckSquare,
    command: (editor) => editor ? editor.chain().focus().clearNodes().toggleTaskList().run() : false,
    isActive: (editor) => editor ? editor.isActive("taskItem") : false,
  },
  {
    name: "Bullet List",
    icon: ListOrdered,
    command: (editor) => editor ? editor.chain().focus().clearNodes().toggleBulletList().run() : false,
    isActive: (editor) => editor ? editor.isActive("bulletList") : false,
  },
  {
    name: "Numbered List",
    icon: ListOrdered,
    command: (editor) => editor ? editor.chain().focus().clearNodes().toggleOrderedList().run() : false,
  ...
  },
  {
    name: "Code",
    icon: Code,
    command: (editor) => editor ? editor.chain().focus().clearNodes().toggleCodeBlock().run() : false,
