  ...
  const items: SelectorItem[] = [
    {
      ...
      command: (editor) => editor ? editor.chain().focus().toggleBold().run() : false,
      icon: BoldIcon,
    },
    {
      name: "italic",
      isActive: (editor) => editor ? editor.isActive("italic") : false,
      command: (editor) => editor ? editor.chain().focus().toggleItalic().run() : false,
      icon: ItalicIcon,
    },
    {
      name: "underline",
      isActive: (editor) => editor ? editor.isActive("underline") : false,
      command: (editor) => editor ? editor.chain().focus().toggleUnderline().run() : false,
      icon: UnderlineIcon,
    },
    {
      name: "strike",
      isActive: (editor) => editor ? editor.isActive("strike") : false,
      command: (editor) => editor ? editor.chain().focus().toggleStrike().run() : false,
      icon: StrikethroughIcon,
    },
    {
      name: "code",
      isActive: (editor) => editor ? editor.isActive("code") : false,
      command: (editor) => editor ? editor.chain().focus().toggleCode().run() : false,
      icon: CodeIcon,
    },
  ];
  return (
