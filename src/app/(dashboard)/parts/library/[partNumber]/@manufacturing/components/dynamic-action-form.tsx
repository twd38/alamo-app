...
import { createWorkInstructionStepAction, updateWorkInstructionStepAction } from "@/lib/actions";
...
export function DynamicActionForm({ stepId, action, onActionSaved }: DynamicActionFormProps) {
            ...
            <form className="space-y-4 p-4 border rounded-lg">
                        ...
                        <FormItem>
                            ...
                            <Select
                                onValueChange={(value) => {
                                    ...
                                    if (field.value === ActionType.VALUE_INPUT && value !== ActionType.VALUE_INPUT) {
                ...
                {actionType === ActionType.VALUE_INPUT && (
                    <div className="space-y-4 p-3 bg-muted/30 rounded-md">
                        <h4 className="text-sm font-medium text-muted-foreground">Value Input Settings</h4>
