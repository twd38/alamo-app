  ...
  const handleSubmit = async (data: FormData) => {
    try {
      const result = await duplicatePart({
        ...
        newName: data.name,
        newPartNumber: data.partNumber || undefined
      });
      ...
      if (result.success && result.data) {
        ...
        setOpen(false);
        form.reset();
        // Navigate to the new part page using part number (following existing pattern)
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a copy of "{partName}" with all its associated data including BOM, work instructions, and files.
          </DialogDescription>
        </DialogHeader>
