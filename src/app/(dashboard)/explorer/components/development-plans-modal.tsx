...
const housingPlans = [
  {
    ...
    name: 'Modern Duplex',
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/duplex_2unit.png',
  ...
  },
  {
    ...
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/combined_3unit.png',
    zoningTypes: ['SF-3', 'SF-4'],
    area: '8,310 sqft',
    units: 3,
    category: 'custom'
  },
  {
    ...
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/stacked_triplex.png',
    zoningTypes: ['MU', 'C-2'],
    area: '2,000 sqft',
    units: 3,
  ...
  },
  {
    ...
    name: 'Row House',
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/rowhouses_4.png',
    zoningTypes: ['R-1'],
    area: '4,000 sqft',
    units: 4,
    category: 'single-family'
  },
  {
    ...
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/point_access_8unit.png',
    zoningTypes: ['R-3', 'MU'],
    area: '2,000 sqft',
    units: 8,
    category: 'multi-family'
  },
  {
    ...
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/point_access_12unit.png',
    zoningTypes: ['R-1'],
    area: '2,400 sq ft',
    units: 12,
    category: 'multi-family'
  },
  {
    ...
    image:
      'https://pub-d17172a416754e0185595c0afbba34ef.r2.dev/point_access_large.png',
    zoningTypes: ['MU', 'C-1'],
    area: '5,000 sq ft',
    units: 24,
    category: 'multi-family'
...
const categories = [
  ...
  },
  {
    id: 'multi-family',
    name: 'Multi-family',
    count: housingPlans.filter((p) => p.category === 'multi-family').length
  },
  { id: 'custom', name: 'Custom designs', count: 0 }
];

export default function DevelopmentPlansModal({
  open,
  onOpenChange
}: {
  open: boolean;
      ...
      <DialogContent className="sm:max-w-[1000px] p-0">
        <div className="flex h-[80vh]">
          ...
          <div className="w-[250px] border-r p-4 bg-muted/30  ">
            ...
            <DialogHeader>
              <DialogTitle className="text-xl pb-8">
                Development Plans
              </DialogTitle>
            </DialogHeader>
              ...
              {filteredPlans.length === 0 && (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">
                    No housing plans found matching your criteria.
                  </p>
                </div>
              )}
            </div>
