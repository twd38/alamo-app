...
async function main() {
  ...
  const roleDefinitions = [
    ...
    },
    {
      name: ROLES.ADMIN,
      description:
        'Administrative access - can manage users and most resources',
      isSystemRole: true
    },
    {
      name: ROLES.MANAGER,
    ...
    },
    {
      ...
      description:
        'Production supervision - can manage work orders and production',
      isSystemRole: true
    },
    {
      name: ROLES.OPERATOR,
      description:
        'Production operator - can execute work instructions and clock in/out',
      isSystemRole: true
    },
    {
      name: ROLES.QUALITY_INSPECTOR,
      description:
        'Quality control - can approve work instructions and inspect work',
      isSystemRole: true
    },
    {
  ...
  const rolePermissions: Record<string, string[]> = {
    [ROLES.SUPER_ADMIN]: Object.values(PERMISSIONS).flatMap((category) =>
